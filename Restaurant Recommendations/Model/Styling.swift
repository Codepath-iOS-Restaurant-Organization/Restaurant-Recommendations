...
//
//  Created by Richard Basdeo on 5/18/21.
//
...
class Styling {
    ...
    static func styleButton (theButton: UIButton){
        theButton.layer.cornerRadius = theButton.frame.height / 2
        theButton.backgroundColor = tier4
        theButton.setTitleColor(tier1, for: .normal)
    }
